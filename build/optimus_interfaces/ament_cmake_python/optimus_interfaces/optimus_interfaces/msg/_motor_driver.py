    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'optimus_interfaces.msg.MotorDriver')
            logger.debug(
...
class MotorDriver(metaclass=Metaclass_MotorDriver):
    ...
    _fields_and_field_types = {
        'motor_pwm_values': 'sequence<int64>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_pwm_values = array.array('q', kwargs.get('motor_pwm_values', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.motor_pwm_values != other.motor_pwm_values:
            return False
        return True
    ...
    @builtins.property
    def motor_pwm_values(self):
        """Message field 'motor_pwm_values'."""
        return self._motor_pwm_values

    @motor_pwm_values.setter
    def motor_pwm_values(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'motor_pwm_values' array.array() must have the type code of 'q'"
            self._motor_pwm_values = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'motor_pwm_values' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._motor_pwm_values = array.array('q', value)
