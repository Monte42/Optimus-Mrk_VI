...
#include "optimus_interfaces/msg/detail/motor_driver__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.motor_pwm_values;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_pwm_values
  {
    ...
    size_t item_size = sizeof(ros_message.motor_pwm_values[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = optimus_interfaces::msg::MotorDriver;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const optimus_interfaces::msg::MotorDriver *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<optimus_interfaces::msg::MotorDriver *>(
    untyped_ros_message);
...
{
  return &optimus_interfaces::msg::typesupport_fastrtps_cpp::_MotorDriver__handle;
}
