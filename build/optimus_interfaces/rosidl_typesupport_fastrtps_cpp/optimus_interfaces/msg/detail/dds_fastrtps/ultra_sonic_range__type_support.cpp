...
#include "optimus_interfaces/msg/detail/ultra_sonic_range__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = optimus_interfaces::msg::UltraSonicRange;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const optimus_interfaces::msg::UltraSonicRange *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<optimus_interfaces::msg::UltraSonicRange *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UltraSonicRange__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const optimus_interfaces::msg::UltraSonicRange *>(
...
static size_t _UltraSonicRange__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UltraSonicRange(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UltraSonicRange__callbacks = {
...
static rosidl_message_type_support_t _UltraSonicRange__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UltraSonicRange__callbacks,
...
{
  return &optimus_interfaces::msg::typesupport_fastrtps_cpp::_UltraSonicRange__handle;
}
